package com.bokun.bkjcb.myapplication.niceapp.ui.widget;
...
public class ProgressHUD extends Dialog {
    ...
    public static ProgressHUD show(Context context, CharSequence textCharSequence, int drawableRes, boolean isCancelable, OnCancelListener onCancelListener) {
